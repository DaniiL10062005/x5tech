...
- [x] Ввести валидный номер `Visa`
- [x] Проверить, что тип карты стал `VISA`
- [x] Ввести валидный `Mastercard`
- [x] Проверить, что тип карты стал `MASTERCARD`
- [x] Ввести невалидный номер
- [x] Проверить ошибку
- [x] Ввести истёкший срок
- [x] Проверить ошибку
- [x] Ввести некорректное имя
- [x] Проверить ошибку
- [x] Ввести неверный `CVV`
- [x] Проверить ошибку
- [x] Заполнить всё валидно
- [x] Проверить активацию кнопки
- [x] Нажать сохранить
- [x] Проверить успешное сохранение
- [x] Переключить скрытие
- [x] Проверить masked view
- [x] Проверить анимацию
...
- [x] Добавить рабочую ссылку на видео
- [x] Добавить рабочую ссылку на APK
